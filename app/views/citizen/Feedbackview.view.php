...
<body class="bg-gray-100">
    <div id="viewRecordPopup" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-xl w-96 p-6">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold text-gray-800">Your Feedback</h2>
            ...
            <form class="space-y-4">
                ...
                <div>
                    <label for="viewRuleDescription" class="block text-sm font-medium text-gray-700">Feedback</label>
                    <textarea 
                        ...
                        placeholder="<?= htmlspecialchars($feedback->Text)?>"
                    ></textarea>
                </div>
                ...
                <div class="flex justify-end space-x-2 pt-4">
                    ...
                    <a href="<?=ROOT?>/citizen/feedback">Back</a>
                </div>
            </form>
            <?php endforeach; ?>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function closePopup() {
            ...
            window.location.href = "<?=ROOT?>/citizen/feedback";
        }
