...
<head>
    ...
    <link rel="stylesheet" href="<?=ROOT?>/assets/css/agn/announcement.css">
...
<body>
    <?php $current_page = 'announcement'; include '../app/views/agn/partials/navbar.php';?>
    ...
    <div class="main-content">
        ...
        <div class="main-sections-wrapper">
                            ...
                            <tr>
                                ...
                                <td class="action-icons">
                                    <button class="view-btn"
                                        ...
                                        data-last_updated="<?= $announcement->updated_at ? date('n/j/Y, g:i:s A', strtotime($announcement->updated_at)) : 'Not yet updated' ?>"
                                    ...
                                    <form action="<?=ROOT?>/agn/Announcement/deleteAnnouncement" method="POST" style="display:inline;">
                                        <input type="hidden" name="id" value="<?=$announcement->id?>">
                                        <button class="view-btn" type="submit" onclick="return confirm('Are you sure you want to delete this announcement?');">
            ...
            <div class="rules-container" style="display:none;">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?=$rule->id?></td>
                                <td><?=$rule->title?></td>
                                <td class="truncate-cell" title="<?=htmlspecialchars($rule->description)?>"><?=$rule->description?></td>
                                ...
                                <td class="action-icons">
                                    <button class="view-btn"
                                        ...
                                        data-last_updated="<?= $rule->updated_at ? date('n/j/Y, g:i:s A', strtotime($rule->updated_at)) : 'Not yet updated' ?>"
                                        data-status="<?=htmlspecialchars($rule->status)?>">
                                        <i class="view-btn fas fa-eye"></i>
                                    </button>
                                    <button
                                    class="view-btn"
                                    onclick="openEditRules(this)"
                                    data-title="<?=$rule->title?>"
                                    data-description="<?=$rule->description?>"
                                    data-status="<?=$rule->status?>"
                                    data-id="<?=$rule->id?>"
                                    data-toggle="ruleEditModal"
                                    >

                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <form action="<?=ROOT?>/agn/Announcement/deleteRule" method="POST" style="display:inline;">
                                        <input type="hidden" name="id" value="<?=$rule->id?>">
                                        <button class="view-btn" type="submit" onclick="return confirm('Are you sure you want to delete this rule?');">
                                            <i class="view-btn fas fa-trash"></i>
                                        </button>
                                    </form>
                                </td>
                            </tr>
                ...
                <div class="insert-new-wrapper">
                    <button class="insert-btn" onclick="openModal('rulesModalOverlay')">
                        <i class="fas fa-plus"></i> Insert New
                    </button>
                </div>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="truncate-cell" title="<?=htmlspecialchars($community_service->description)?>"><?=$community_service->description?></td>
                                ...
                                <td class="action-icons">
                                    <button class="view-btn"
                                        ...
                                        data-last_updated="<?= $community_service->updated_at ? date('n/j/Y, g:i:s A', strtotime($community_service->updated_at)) : 'Not yet updated' ?>"
                                    ...
                                    <form action="<?=ROOT?>/agn/Announcement/deleteCommunityService" method="POST" style="display:inline;">
                                        <input type="hidden" name="id" value="<?=$community_service->id?>">
                                        <button class="view-btn" type="submit" onclick="return confirm('Are you sure you want to delete this community service?');">
                                            <i class="fas fa-trash"></i>
                                        </button>
                                    </form>
                                </td>
    ...
    <div class="modal-overlay" id="announcementModalOverlay" style="display:none;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="announcementForm" action="<?=ROOT?>/agn/Announcement/insertAnnouncement" method="POST">
                    <label>Announcement Title</label>
                    <input type="text" name="title" required style="background:#f5f7fa; border-radius:6px; margin-bottom:12px;">
                    <label>Description</label>
                    <textarea name="description" required style="background:#f5f7fa; border-radius:6px; margin-bottom:12px;"></textarea>
                    <label>Status</label>
                    <select name="status" style="background:#f5f7fa; border-radius:6px; margin-bottom:12px;">
    ...
    <div class="modal-overlay" id="rulesModalOverlay" style="display:none;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h2>Add New Rule</h2>
                <form id="rulesForm" action="<?=ROOT?>/agn/Announcement/insertRule" method="POST">
                    ...
                    <button type="submit" class="insert-btn">Save Rule</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="communityModalOverlay" style="display:none;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="communityForm" action="<?=ROOT?>/agn/Announcement/insertCommunityService" method="POST"> 
    ...
    <div class="modal-overlay" id="announcementedit" style="display:none;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="announcementeditform" action="<?=ROOT?>/agn/Announcement/editAnnouncement" method="POST">
     ...
     <!-- edit rule modal -->
     <div class="modal-overlay" id="ruleedit" style="display:none;">
        <div class="modal-content">
            <span class="modal-close" onclick="closeModal('ruleedit')">&times;</span>
            <div class="modal-body">
                <h2>Edit Rules</h2>
                <form id="ruleeditform" action="<?=ROOT?>/agn/Announcement/editRule" method="POST">
                    <input type="hidden" name="id" id="ruleid">
                    <label>Rule Title</label>
                    <input type="text" name="title" id="ruletitle" required>
                    <label>Description</label>
                    <textarea name="description" id="ruledesc" required></textarea>
                    <label>Status</label>
     ...
     <div class="modal-overlay" id="communityserviceedit" style="display:none;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="communityserviceeditform" action="<?=ROOT?>/agn/Announcement/editcommunityservice" method="POST">
                    <input type="hidden" name="id" id="communityserviceid">
                    <label>Announcement Title</label>
                    <input type="text" name="title" id="communityservicetitle" required><!--agn wage gddinm me id ekth wens wenn one i think-->
                    <label>Description</label>
...
<script src="<?=ROOT?>/assets/js/agn/announcement.js"></script>
</html>